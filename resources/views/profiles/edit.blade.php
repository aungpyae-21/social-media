           ...
           <div class="row">
                <div class="col-8 offset-2">
                    ...
                    <div class="form-group row">
                        ...
                        <input id="description" type="text" class="form-control @error('description') is-invalid @enderror" name="description" value="{{ old('dexcription') ?? $user->profile->description }}" autocomplete="title">
